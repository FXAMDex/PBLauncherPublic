...
namespace PBLauncher
{
    public static class Connect
    {
        ...
        /// </summary>
        private static readonly string HostURL = "http://localhost/HTDOCS/game_launcher.conf";
        public static string GameName = "PBLauncher";
        ...
        public static string LoginForm, VersionGameLogin, _useXCLoader;
        public static int _version;
        public static bool  _keyHost;
                        ...
                        if (line.Contains("="))
                        {
                            ...
                            switch (id)
                            {
                                case "launcherversion":
                                    ...
                                    break;
                                case "login_form":
                                    LoginForm = Get.Conf(line, id);
                                    break;
                                case "version_game":
                                    VersionGameLogin = Get.Conf(line, id);
                                    break;
                                case "status":
